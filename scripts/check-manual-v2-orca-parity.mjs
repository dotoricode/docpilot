...
assert.deepEqual(mergedReleases.map(release => release.version), ['2.0.3', '2.0.2', '2.0.1', '2.0.0', '1.0.28', '1.0.27'], 'release candidate and verified v2/v1 history must remain visible when remote data is partial');
