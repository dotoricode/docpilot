...
const RELEASE_NOTES: Record<string, ReleaseNoteItem[]> = {
  '1.0.28': [
    ...
    {
      title: '패키지 앱에서도 AsciiDoc 미리보기가 열립니다',
      body: '앱에 포함된 AsciiDoc 변환 워커가 필요한 라이브러리를 안정적으로 불러오도록 보완해, 렌더링 오류 없이 미리보기를 표시합니다.',
    },
    {
      title: '추가 폴더를 최근 폴더에서 다시 찾을 수 있습니다',
      body: '작업공간에 추가한 폴더를 최근 폴더 목록에도 기록하고, 같은 경로는 가장 최근 항목 하나만 남도록 정리했습니다.',
    },
  ],
  '1.0.27': [
    {
